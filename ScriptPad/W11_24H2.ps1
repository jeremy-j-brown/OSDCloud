...
https://raw.githubusercontent.com/jeremy-j-brown/OSDCloud/refs/heads/main/AP-Prereq.ps1 | Out-File -FilePath 'C:\Windows\Setup\scripts\autopilotprereq.ps1' -Encoding ascii -Force
