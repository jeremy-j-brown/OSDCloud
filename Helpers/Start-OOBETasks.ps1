...
Start-Process PowerShell -ArgumentList "-NoL -C Invoke-WebPSScript https://raw.githubusercontent.com/jjblab/OSD/main/Set-KeyboardLanguage.ps1" -Wait

Write-Host -ForegroundColor DarkGray "Executing Autopilot Check Script"
Start-Process PowerShell -ArgumentList "-NoL -C Invoke-WebPSScript https://raw.githubusercontent.com/jjblab/OSD/main/Check-AutopilotRequirements.ps1" -Wait

Write-Host -ForegroundColor DarkGray "Executing AutopilotOOBE Module"
Start-Process PowerShell -ArgumentList "-NoL -C Invoke-WebPSScript https://raw.githubusercontent.com/jjblab/OSD/main/Start-AutopilotOOBE.ps1" -Wait
...
Start-Process PowerShell -ArgumentList "-NoL -C Invoke-WebPSScript https://raw.githubusercontent.com/jjblab/OSD/main/Clean-OSD.ps1" -Wait
...
Invoke-WebRequest https://github.com/jjblab/OSDCloud/raw/main/Tools/ServiceUI64.exe -OutFile "C:\OSDCloud\ServiceUI.exe"
